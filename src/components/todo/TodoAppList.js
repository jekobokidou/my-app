                ...
                <Router>
                    <HeaderComponent/>
                        <Switch>
                            ...
                            <Route path="/welcome/:loginname" component={WelcomeParamComponent}/>
            ...
            <header>
                <nav className="navbar navbar-expand-md navbar-dark bg-primary">
                    ...
                    <ul className="navbar-nav">
                        <li><Link className="nav-item nav-link" to="/">Accueil</Link></li>
                        <li><Link className="nav-item nav-link" to="/tasks">Tâches</Link></li>
                    </ul>
                    <ul className="navbar-nav navbar-collapse justify-content-end">
                        <li><Link className="nav-item nav-link" to="/login">Connexion</Link></li>
                        <li><Link className="nav-item nav-link" to="/logout">Déconnexion</Link></li>
                    </ul>
                </nav>
            </header>
        )
